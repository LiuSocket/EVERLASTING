#ifndef GMMMATERIALTOOSGSTATESET_H
#define GMMMATERIALTOOSGSTATESET_H
...
public:
    ...
    //dir is the directory where gmm is stored (for relative path).
...
private:
    //Convert a texture gmm to an osg texture.
    osg::ref_ptr<osg::Texture2D> gmmTextureToOsgTexture(const FbxFileTexture* pOsgTex);
    ...
    FbxMaterialMap       _gmmMaterialMap;
    ImageMap              _imageMap;
...
#endif //GMMMATERIALTOOSGSTATESET_H
