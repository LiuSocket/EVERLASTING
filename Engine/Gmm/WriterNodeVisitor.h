...
#ifndef _GMM_WRITER_NODE_VISITOR_HEADER__
#define _GMM_WRITER_NODE_VISITOR_HEADER__
...
typedef std::map<VertexIndex, unsigned int> MapIndices;        ///< Map OSG indices to GMM mesh indices
...
class WriterNodeVisitor: public osg::NodeVisitor
{
    public:
        ...
        {
        public:
            ///Create a KgmmMaterial and KgmmTexture from osg::Texture and osg::Material.
        ...
        private:
            FbxSurfacePhong*  _gmmMaterial;
            FbxFileTexture*   _gmmTexture;
    ...
    protected:
        /// Compares StateSets.
        ///\todo It may be useful to compare stack of pointers (see pushStateset()) in order to keep the same number of GMM materials when doing reading and then writing without further processing.
    ...
    private:
        ...
        */
        ...
        ///We store the gmm Materials and Textures in this map.
...
#endif // _GMM_WRITER_NODE_VISITOR_HEADER__
