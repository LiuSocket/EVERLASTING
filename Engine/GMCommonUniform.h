...
namespace GM
{
    /*************************************************************************
     Macro Defines
    *************************************************************************/
    #define GM_UNIFORM           CGMCommonUniform::getSingleton()
    ...
    */
    class CGMCommonUniform : public CGMSingleton<CGMCommonUniform>
    {
        // 函数
    public:
        /** @brief 获取单例 */
        static CGMCommonUniform& getSingleton(void);

        /** @brief 构造 */
        CGMCommonUniform();
        /** @brief 析构 */
        virtual ~CGMCommonUniform();
        /** @brief 初始化 */
